            ...
            <TableBody>
                {users.map((user) => (
                    <TableRow className={classes.row} key={user.id}>
                        ...
                        <TableCell>
                            <Button className={classes.change} color="primary" variant="contained" style={{marginRight:10}} component={Link} to={`/edit/${user._id}`}>Edit</Button> {/* change it to user.id to use JSON Server */}
